...
num_in_c = UnityEngine.GameObject.Find("ScriptHolder").GetComponent("CallingPythonWrapper").callingPython.num_in_c
...
UnityEngine.GameObject.Find("ScriptHolder").GetComponent("CallingPythonWrapper").callingPython.num_in_c = 4

# Getting the value of the String variable called string_in_c from the calling C# script
string_in_c = UnityEngine.GameObject.Find("ScriptHolder").GetComponent("CallingPythonWrapper").callingPython.string_in_c
UnityEngine.GameObject.Find("oldValues").GetComponent("UnityEngine.UI.Text").text += "\nstring_in_c: " + string_in_c

# Setting the value of the String variable called string_in_c in the C# script
UnityEngine.GameObject.Find("ScriptHolder").GetComponent("CallingPythonWrapper").callingPython.string_in_c = "new string"
...
# access in Python.
array_in_c = UnityEngine.GameObject.Find("ScriptHolder").GetComponent("CallingPythonWrapper").callingPython.array_in_c
length_array_in_c = UnityEngine.GameObject.Find("ScriptHolder").GetComponent("CallingPythonWrapper").callingPython.length_array_in_c
list_in_python = []
...
UnityEngine.GameObject.Find("ScriptHolder").GetComponent("CallingPythonWrapper").callingPython.new_length_array_in_c = len(list_in_python)
for i in range(0, len(list_in_python)):
    UnityEngine.GameObject.Find("ScriptHolder").GetComponent("CallingPythonWrapper").callingPython.new_arraylist_in_c.Add(list_in_python[i])
