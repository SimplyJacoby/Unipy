    ...
    public void RunCallingPython()
    {
        ...
        using (Py.GIL())
        {
            try
            {
                ...
                //{
                //    scope.Exec("import UnityEngine");
                //    scope.Set("hello", hello);
                //    scope.Exec("hello = hello + 'world'");
                //    scope.Exec("UnityEngine.GameObject.Find('ScriptHolder').GetComponent('CallingPythonWrapper').hello = hello");
                //}
            }
